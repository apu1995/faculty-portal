  ...
  <head>
    <title>LUSIP</title>
        ...
        function validate()
      {
          ...
          else if(document.changepass.rpass.value=="")
          {
            alert("Please Re-enter the password !");
            document.getElementById("changepass").reset();
            return(false);
          }
          else if(document.changepass.rpass.value !=document.changepass.pass.value)
          {
...
<body>
  <div id="main">
      ...
      <div id="menubar">
        <ul id="menu" class="drop">
          ...
          <li><a href="changepass.php">New Project</a></li>
  ...
  <div id="site_content">
    ...
    <form method="post" name="changepass" action="change.php">
      <input type="password" maxlength="30" name="pass" placeHolder="New Password" id="form"/></br><br /><br />
      <input type="password" maxlength="30" name="rpass" placeHolder="Re-Enter New Password" id="form"/></br>
